...
# plotting idea from http://rpubs.com/jmallmann/rr_peer_assignment2
#barplot(summaryStdEventTypesAffectingHealth$newTotalAffected[1:10], beside = TRUE,
#        names.arg = summaryStdEventTypesAffectingHealth$StandardEventType[1:10],
#        legend = summaryStdEventTypesAffectingHealth$StandardEventType[1:10], 
#        main = "Standardized Event Types Most Affecting Population Health\nJan 1996 - Nov 2011",
#        col = c("lightblue", "mistyrose", "lightcyan", "lavender", "cornsilk", "salmon", "peachpuff", "palegreen", "orchid", "lightyellow"),
#        ylim = c(0, 23000))


# More plotting from http://rpubs.com/mindyng/113717
# ggplot(susS,aes(event,fatalities.injuries)) + 
#         geom_point(aes(colour=event)) + 
#         theme(legend.position="none",axis.text.x = element_text(angle = 45, hjust = 1)) + 
#         ggtitle('Fatalities & Injuries from Major Disasters')
